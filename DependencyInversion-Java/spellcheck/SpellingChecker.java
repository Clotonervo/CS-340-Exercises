...
public class SpellingChecker {
	...
	public SortedMap<String, Integer> check(String path, DataRetreiver fetcher, DictionaryInterface dictionary, WordExtractorInterface extractor) throws IOException {
